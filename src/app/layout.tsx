...
import RootHeader from "@/ui/2.common-components/1.Header/RootHeader";
import Footer from "@/ui/2.common-components/2.Footer/Footer";
import Redux_provider from "@/vendors/2.redux/Provider";
import Tenstack_provider from "@/vendors/3.tenstack-query/Tenstack_provider";
// ---------------------------------------------------------------
  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        <RootHeader />
        <Redux_provider>
          <Tenstack_provider>{children}</Tenstack_provider>
        </Redux_provider>
        <Footer />
      </body>
    </html>
