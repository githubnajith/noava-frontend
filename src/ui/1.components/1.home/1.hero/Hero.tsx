      ...
      <section className="pb-4 md:p-0">
        <main className="">
          <section className="relative md:flex justify-center items-center hidden">
            <div className="absolute w-full h-full bg-gray-400 bg-opacity-50"></div>
            <img className="" loading="lazy" src="https://firebasestorage.googleapis.com/v0/b/noava-25035.appspot.com/o/noava%2Fhome%2Fdesktop%20hero%20%20skins%20and%20wrap.webp?alt=media&token=32ad42d7-b0e7-44f9-848a-b6d857dca8ff" alt="" />
        ...
        <main className="md:hidden">
          <div className="">
            <img loading="lazy" src="https://firebasestorage.googleapis.com/v0/b/noava-25035.appspot.com/o/noava%2Fhome%2Fmobile%20hero%20skins%20and%20wraps.webp?alt=media&token=a97956c2-c5ef-4d2a-a009-45dd6834cac8" alt="mobile skin" />
