...
const EditAddress_ui = (props) => {
  ...
  useEffect(() => {
    ...
    if (name && whatsappNum && street && doorNo && landmark && pincode)
      setFillall(false);
  ...
  useEffect(() => {
    ...
    props.getEditState(uploadComplete);
  }, [uploadComplete]); 
  // ----------------------------------------
      ...
      {userAuth && (
        <div className="py-2">
          ...
          <main className="flex flex-col items-center justify-center bg-gray-50 mx-4">
            ...
            {fillAll && (
              <label className="text-sm py-2 block text-red-500">
