    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 space-y-4 md:grid-cols-2 md:space-y-4 lg:grid-cols-4 py-3 space-x-2 px-4 w-10/12 m-auto">
        ...
        <div className="my-auto py-4 text-center space-y-4 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] mt-[16px] ml-[8px]">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            className="w-[80px] m-auto h-[80px] object-contain"
            src="/2.contact/mobile.png"
            alt="Mobile icon"
          />
          ...
          <a
            target="_blank"
            href="tel:9363137070"
            className="block bg-blue-500 text-white font-semibold p-3 rounded w-24 m-auto"
          >
            call us
          </a>
        </div>
        ...
        <div className="my-auto py-4 text-center space-y-4 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
          ...
          <img
            className="w-[80px] m-auto h-[80px] object-contain"
            src="/2.contact/whatsapp.png"
            alt="whatsapp icon"
          />
          <h3 className="font-semibold text-gray-500">8608244255</h3>
          <a
            target="_blank"
            href="https://wa.me/+918608244255"
            className="block bg-green-600 text-white font-semibold p-3 rounded w-24 m-auto"
          >
            whatsapp
          </a>
        </div>
        ...
        <div className="my-auto py-4 text-center space-y-4 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
          ...
          <img
            className="w-[80px] m-auto h-[80px] object-contain"
            src="/2.contact/gmail.png"
            alt="Gmail icon"
          />
          <h3 className="font-semibold text-gray-500">support@noava.in</h3>
          <a className="block bg-orange-600 text-white font-semibold p-3 rounded w-24 m-auto">
            Email
          </a>
        </div>
        {/* email */}
        <div className="my-auto py-4 text-center space-y-4 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
          ...
          <a
            ...
            className="block bg-sky-600 text-white font-semibold p-3 rounded w-24 m-auto"
          >
            map
          </a>
        </div>
