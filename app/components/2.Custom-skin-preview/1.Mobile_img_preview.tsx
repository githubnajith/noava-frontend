    ...
    <div className='py-4'>
      ...
      <div className='relative mx-auto border-gray-800 dark:border-gray-500 bg-gray-300 border-[2px] rounded-[2.5rem] h-[500px] w-[250px]'>
        <input
          ...
          type='file'
          accept='image/*'
          className='h-full absolute z-10 opacity-0  w-full outline rounded-xl'
        />
        {!image && (
        ...
        <div className='absolute h-[100px] w-[100px] rounded-full m-3 flex justify-center items-center'>
          ...
          <img
            src='https://firebasestorage.googleapis.com/v0/b/noava-25035.appspot.com/o/noava%2Fhome%2Fassets%2Fbackcamera.webp?alt=media&token=f7ceebc6-c380-41c0-8572-12427d6eb4a8'
            loading='lazy'
            alt='camera icon'
          />
        </div>
        ...
        {image && (
          <>
            ...
            <img
              src={image}
              className='w-[250px] h-[495px] object-cover rounded-[40px]'
