...
const ProductScroll_ui = (props: PropsWithChildren<Props>) => {
  // --------------------------------------------------
  ...
  return (
    <section>
      ...
      <div
        ref={sliderRef}
        onMouseDown={mouseTrue}
        onMouseLeave={mouseFalse}
        onMouseUp={mouseFalse}
        onMouseMove={mouseMove}
        className='scroll-smooth shadow gap-5 overflow-x-auto py-4 px-2 whitespace-nowrap space-x-4 cursor-pointer no-scrollbar'
      >
        {props.children}
      </div>
...
export default ProductScroll_ui;
